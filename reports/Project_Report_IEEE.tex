...
\subsection{User Interface Results (ML Engineer Focus)}
The following sequences show the complete application flow for resume analysis and ML Engineer role matching. All screenshots were captured from a live local run of the application using comprehensive full-page captures that show all relevant information:

\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\linewidth]{report_assets/01_home_interface.png}
\caption{Home Interface: Main upload page with resume input and CV scan button.}
\label{fig:home_interface}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\linewidth]{report_assets/02_resume_selected.png}
\caption{Resume Selection: PDF file selected for analysis and ready for scanning.}
\label{fig:resume_selected}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\linewidth]{report_assets/03_cv_scan_top.png}
\caption{CV Scan Results (Top): Overview section with CV score and profile status assessment.}
\label{fig:cv_scan_top}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\linewidth]{report_assets/04_cv_scan_middle.png}
\caption{CV Scan Results (Middle): Recommended roles and detailed profile capabilities.}
\label{fig:cv_scan_middle}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\linewidth]{report_assets/05_cv_scan_bottom.png}
\caption{CV Scan Results (Bottom): Strengths and improvement areas identified.}
\label{fig:cv_scan_bottom}
\end{figure}

\begin{figure}[htbp]
\centering
\includegraphics[width=0.95\linewidth]{report_assets/06_role_selected.png}
\caption{Role Selection \& Job Description: ML Engineer role selected with detailed job requirements and analysis interface.}
\label{fig:role_selected}
\end{figure}
